        ...
        <div className="flex items-center justify-center text-center">
          ...
          <div className="md:w-1/2">
            <div className="flex">
              ...
              <img src="https://i.postimg.cc/qqHpWz1Z/Container.png" alt="" className="w-11 h-10" />
            </div>
            <div className="flex">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group">
            <div className="overflow-hidden rounded-lg mb-4">
              <img
                src="https://i.postimg.cc/Tw80b67X/Image1.png"
          ...
          <div className="group">
            <div className="overflow-hidden rounded-lg mb-4">
              <img
                src="https://i.postimg.cc/nztKz1rF/Image2.png"
          ...
          <div className="group">
            <div className="overflow-hidden rounded-lg mb-4">
              <img
                src="https://i.postimg.cc/J49sMzGm/Image3.png"
